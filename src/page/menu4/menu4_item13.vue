...
<style>
  ...
  .Education .topHead .el-button{
    float: left;
  }
  .Education .chunk{
    float: left;
  }
  .Education .topHead .el-option{
    float: left;
  }
  .Education .topHead .search{
    float: right;
  }
  .Education .topHead .el-form-item__label{
    float: left;
    width: 85px;
    height: 32px;
    text-align: center;
  ...
  .Education .topHead .search .el-button{
    width: 73px;
    height: 32px;
    margin-left: 20px;
    float: right;
  }
  .Education .el-pagination{
    float: right;
  }
</style>
