...
<style>
  ...
  .EducationDept .topHead .el-button{
    float: left;
  }
  .EducationDept .chunk{
    float: left;
  }
  .EducationDept .topHead .el-option{
    float: left;
  }
  .EducationDept .topHead .search{
    float: right;
  }
  .EducationDept .topHead .el-form-item__label{
    float: left;
    width: 85px;
    height: 32px;
    text-align: center;
  ...
  .EducationDept .topHead .el-input{
  ...
  .EducationDept .topHead .search .el-button{
    width: 73px;
    height: 32px;
    margin-left: 20px;
    float: right;
  }
  .EducationDept .el-pagination{
    float: right;
  }
</style>
